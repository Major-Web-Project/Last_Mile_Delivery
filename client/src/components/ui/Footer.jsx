      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">LastMileDelivery</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Streamlining last-mile delivery operations with lightweight solutions.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/user" className="text-gray-400 hover:text-white transition">User Portal</Link></li>
                <li><Link to="/driver" className="text-gray-400 hover:text-white transition">Driver Portal</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Get the latest updates on our delivery solutions
            </p>
            <form className="flex">
              <input
                type="email"
              ...
              <button
                type="submit"
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-r-lg transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            LastMileDelivery &copy; {new Date().getFullYear()}  Copyright Reserved
          </p>
